...
# Output weights
weight_out = tf.Variable(weight_initializer([n_neurons_1, 1]))
...
out = tf.transpose(tf.add(tf.matmul(hidden_1, weight_out), bias_out))
...
mse_stats.to_csv('stats/nn_2L_softplus_b128.csv')

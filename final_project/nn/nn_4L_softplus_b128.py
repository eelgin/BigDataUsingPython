...
# Hidden layer
hidden_0 = tf.nn.softplus(tf.add(tf.matmul(stock_p,  W_hidden_0), bias_hidden_0))
hidden_1 = tf.nn.softplus(tf.add(tf.matmul(hidden_0, W_hidden_1), bias_hidden_1))
hidden_2 = tf.nn.softplus(tf.add(tf.matmul(hidden_1, W_hidden_2), bias_hidden_2))
hidden_3 = tf.nn.softplus(tf.add(tf.matmul(hidden_2, W_hidden_3), bias_hidden_3))
...
mse_stats.to_csv('stats/nn_4L_softplus_b128.csv')
